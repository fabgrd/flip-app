...
export function ConfettiPiece({
  ...
  useEffect(() => {
    ...
    const timeout = setTimeout(() => {
      translateY.value = withTiming(SCREEN_HEIGHT + 40, {
  ...
  return (
    <Animated.View
      style={[
        ...
        style,
        { backgroundColor: piece.color, width: piece.size, height: piece.size * 2 },
      ]}
    />
  );
}
...
const styles = StyleSheet.create({
  confettiPiece: { borderRadius: 2, position: 'absolute', top: 0 },
});
